...
export default {
  methods: {
    config() {
      ...
      console.log("TCL: config -> currentUrl", currentUrl)


      axios
        .get('/we-chat/signature', {
          params: {
            // url: currentUrl
            url: window.weChatEntryUrl
...
setTimeout(() => {
console.log("TCL: mounted -> window.location.href updateAppMessageShareData", window.location.href)
